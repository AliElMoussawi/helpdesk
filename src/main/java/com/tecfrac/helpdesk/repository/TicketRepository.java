...
public interface TicketRepository extends JpaRepository<ModelTicket, Integer> {
    ...
    public List<ModelTicket> findAllByAssignedGroupIdAndStatusIdNot(int i, int solved);
    ...
    public List<ModelTicket> findAllByAssignedGroupIdAndStatusId(Integer i, int NEW);
    ...
    public List<ModelTicket> findAllByStatusIdNotInAndAssignedGroupId(List<Integer> asList, Integer i);
    ...
    public List<Object[]> countAllByStatusId(@Param("groupId") Integer i);
    ...
    public List<ModelTicket> findAllByStatusIdNotInAndAssignedUserAndAssignedGroupId(List<Integer> asList, Object object, Integer i);
